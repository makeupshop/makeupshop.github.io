...
function preLoadPageToCurrentHash() {
	...
	if (typeof currentSearch.item !== "undefined") {
		...
		if (typeof searchResult !== "undefined") {
			...
			textMain += '<a href="http://makeupshop.github.io" target="_blank"><span id="footerInfo">Makeup &copy; 2017</span></a>';
			textMain += '<a href="https://www.inoreader.com/feed/http://feeds.feedburner.com/rss/makeupshop" target="_blank"><span id="footerRSS"></span></a>';
			textMain += '</div>';
			textMain += '</footer>';
			...
			textHTML += '		<meta name="google-site-verification" content="6Zx6CgvinlomY-kyMRogBDpo2RAHQTWGy7RpekcRLy8" />\n';
			...
			textHTML += '		<title>Makeup - Buy ' + searchResult.title + '</title>\n';
			textHTML += '		<meta name="description" content="' + searchResult.title + '" />\n';
			textHTML += '		<meta name="keywords" content="Makeup, ' + searchResult.title.split("  ").join(" ").split(" ").join(", ") + '" />\n';
			textHTML += '		<meta property="og:type" content="product" />\n';
			textHTML += '		<meta property="og:title" content="Makeup" />\n';
			...
			textHTML += '		<meta property="og:url" content="https://makeupshop.github.io/#' + searchResult.search + '" />\n';
			textHTML += '		<meta name="twitter:card" content="summary_large_image" />\n';
			textHTML += '		<meta name="twitter:site" content="@makeupshop01" />\n';
			textHTML += '		<link rel="canonical" href="https://makeupshop.github.io/#' + searchResult.search + '" />\n';
			...
			textHTML += '		<meta name="apple-mobile-web-app-title" content="Makeup" />\n';
			textHTML += '		<meta name="application-name" content="Makeup" />\n';
			...
			textHTML += '		<link rel="alternate" type="application/rss+xml" title="RSS Feed for Makeup" href="http://feeds.feedburner.com/rss/makeupshop" />\n';
			textHTML += '		<link rel="stylesheet" href="css/main.css" />\n';
			textHTML += '		<script>(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","https://www.google-analytics.com/analytics.js","ga");ga("create", "UA-94031100-1", "auto");ga("send", "pageview");</script>\n';
			textHTML += '	</head>\n';
			textHTML += '	<body>\n';
	...
	if (App.currentHash !== "") {
		...
		if (typeof searchResult !== "undefined") {
			...
			$("meta[name='keywords']").attr("content", "Makeup, " + searchResult.title.split("  ").join(" ").split(" ").join(", "));
			...
			$("meta[property='og\\:url']").attr("content", "https://makeupshop.github.io/#" + searchResult.search);
...
function getmakeupshopTwitterPage() {
	openURL("https://twitter.com/makeupshop01");
}

function getmakeupshopPage() {
	openURL("https://goo.gl/vFftYE");
}

function getInfoPage() {
	openURL("http://makeupshop.github.io");
}

function getRSSPage() {
	openURL("https://www.inoreader.com/feed/http://feeds.feedburner.com/rss/makeupshop");
}

function getmakeupshopTelegramPage() {
	openURL("http://telegram.me/makeupshop01");
}
...
$(document).ready(function () {
	...
	textMain += '<span id="titlePage">Makeup</span>';
	...
	textMain += '<footer>';
	textMain += '<div id="footerPage">';
	textMain += '<span id="footerInfo">Makeup &copy; 2017</span>';
	...
	App.elementLogoImage.click(function () {
		getmakeupshopTwitterPage();
		my_ga('send', 'event', 'getmakeupshopTwitterPage', 'click', 'elementLogoImage');
	});

	App.elementTitlePage.click(function () {
		getmakeupshopPage();
		my_ga('send', 'event', 'getmakeupshopPage', 'click', 'elementTitlePage');
	});
